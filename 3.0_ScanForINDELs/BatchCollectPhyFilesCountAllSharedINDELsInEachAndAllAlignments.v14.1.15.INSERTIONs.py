...
hypotheses = 'IndelPhylogeneticHypotheses_AllTaxa.v14.15.txt'
...
outdir = 'GenesWithINDELsSupportingAHypothesis_v14_1_15_PrimatomorphaINSERTIONS'
ordertaxaoutput = ['Homo', 'Pan', 'Gorilla', 'Pongo', 'Nomascus', 'Papio', 'Macaca', 'Callithrix', 'Tarsius', 'Otolemur', 'Microcebus', 'GVA', 'TCH', 'Tupaia', 'Mus', 'Rattus', 'Dipodomys', 'Cavia', 'Ictidomys', 'Oryctolagus', 'Ochotona', 'Ovis', 'Bos', 'Tursiops', 'Sus', 'Vicugna', 'Mustela', 'Ailuropoda', 'Canis', 'Felis', 'Equus', 'Pteropus', 'Myotis', 'Sorex', 'Erinaceous', 'Dasypus', 'Choloepus', 'Procavia', 'Loxodonta', 'Echinops'] # NOTE: !!! ONLY TAXA IN THIS LIST WILL BE PRINTED OUT TO HIGHLIGHTED ALIGNED FASTA FILES FOR HIGHLIGHTED INDELs !!! # 'Macropus', 'Sarcophilus', 'Monodelphis', 'Ornithorhynchus'
...
def main():
	...
	WriteOUT('INDELsSupportingHypothesesCounts.v14.1.15.txt', output)
	output = FormatOutputLists(allindelspergene, allgene)
	WriteOUT('INDELsSupportingHypotheses_PerGene.v14.1.15.txt', output)
